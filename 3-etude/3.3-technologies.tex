...
\subsection{Le back-office}
  ...
  Pour réaliser une application monopage, il existe un certains nombres de \glspl{framwork} différents qui fonctionent chacun avec un paradigme différent. Vous trouverez une présentation détaillé de ces framework et de leur différences dans le \fullref{sec:monopage}.
